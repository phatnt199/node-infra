...
declare const BaseApplication_base: (new (...args: any[]) => {
    ...
    start(): Promise<void>;
    boot(): Promise<void>;
    booters(...booterCls: Constructor<import("@loopback/boot").Booter>[]): import("@loopback/boot").Binding<any>[];
    ...
    component<C extends import("@loopback/core").Component = import("@loopback/core").Component>(componentCtor: Constructor<C>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined): import("@loopback/boot").Binding<C>;
    ...
    serviceProvider<S_1>(provider: Constructor<import("@loopback/core").Provider<S_1>>, nameOrOptions?: string | import("@loopback/core").ServiceOptions | undefined): import("@loopback/boot").Binding<S_1>;
    component<C_1 extends import("@loopback/core").Component = import("@loopback/core").Component>(componentCtor: Constructor<C_1>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined): import("@loopback/boot").Binding<C_1>;
    mountComponentServices<C_1_1 extends import("@loopback/core").Component = import("@loopback/core").Component>(component: Constructor<C_1_1>, componentBindingKey?: import("@loopback/core").BindingAddress<C_1_1> | undefined): void;
    readonly options: ApplicationConfig;
    readonly state: string;
    ...
    server: <T_1_1 extends import("@loopback/core").Server>(ctor: Constructor<T_1_1>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined) => import("@loopback/boot").Binding<T_1_1>;
    servers: <T_2_1 extends import("@loopback/core").Server>(ctors: Constructor<T_2_1>[]) => import("@loopback/boot").Binding<any>[];
    getServer: <T_3_1 extends import("@loopback/core").Server>(target: string | Constructor<T_3_1>) => Promise<T_3_1>;
    init: () => Promise<void>;
    onInit: (fn: () => import("@loopback/core").ValueOrPromise<void>) => import("@loopback/boot").Binding<import("@loopback/core").LifeCycleObserver>;
    start: () => Promise<void>;
    onStart: (fn: () => import("@loopback/core").ValueOrPromise<void>) => import("@loopback/boot").Binding<import("@loopback/core").LifeCycleObserver>;
    ...
    onStop: (fn: () => import("@loopback/core").ValueOrPromise<void>) => import("@loopback/boot").Binding<import("@loopback/core").LifeCycleObserver>;
    setMetadata: (metadata: import("@loopback/core").ApplicationMetadata) => void;
    lifeCycleObserver: <T_4_1 extends import("@loopback/core").LifeCycleObserver>(ctor: Constructor<T_4_1>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined) => import("@loopback/boot").Binding<T_4_1>;
    ...
    server: <T_1_2 extends import("@loopback/core").Server>(ctor: Constructor<T_1_2>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined) => import("@loopback/boot").Binding<T_1_2>;
    servers: <T_2_2 extends import("@loopback/core").Server>(ctors: Constructor<T_2_2>[]) => import("@loopback/boot").Binding<any>[];
    getServer: <T_3_2 extends import("@loopback/core").Server>(target: string | Constructor<T_3_2>) => Promise<T_3_2>;
    init: () => Promise<void>;
    onInit: (fn: () => import("@loopback/core").ValueOrPromise<void>) => import("@loopback/boot").Binding<import("@loopback/core").LifeCycleObserver>;
    start: () => Promise<void>;
    onStart: (fn: () => import("@loopback/core").ValueOrPromise<void>) => import("@loopback/boot").Binding<import("@loopback/core").LifeCycleObserver>;
    ...
    onStop: (fn: () => import("@loopback/core").ValueOrPromise<void>) => import("@loopback/boot").Binding<import("@loopback/core").LifeCycleObserver>;
    setMetadata: (metadata: import("@loopback/core").ApplicationMetadata) => void;
    lifeCycleObserver: <T_4_2 extends import("@loopback/core").LifeCycleObserver>(ctor: Constructor<T_4_2>, nameOrOptions?: string | import("@loopback/core").BindingFromClassOptions | undefined) => import("@loopback/boot").Binding<T_4_2>;
